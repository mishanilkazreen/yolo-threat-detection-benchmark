...
class ConfigurationParser:
    ...
    @staticmethod
    def parse(config_path: Union[str, Path]) -> Configuration:
        """
    ...
    @staticmethod
    def _parse_dict(data: Dict[str, Any], source: Union[str, Path]) -> Configuration:
        """
    ...
    @staticmethod
    def _parse_training(data: Dict[str, Any], source: Union[str, Path]) -> TrainingConfig:
        ...
        try:
            ...
            raise ConfigurationParseError(f"image_size must be an integer, got: {data['image_size']}")
    ...
    @staticmethod
    def _parse_model(data: Dict[str, Any], source: Union[str, Path]) -> ModelConfig:
    ...
    @staticmethod
    def _parse_data(data: Dict[str, Any], source: Union[str, Path]) -> DataConfig:
