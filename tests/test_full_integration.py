...
def test_full_integration():
    ...
    try:
        ...
        assert hasattr(runner, '_run_incremental_training'), "Missing _run_incremental_training method"
        ...
        assert hasattr(metrics_collector, 'collect_round_metrics'), "Missing collect_round_metrics method"
        assert hasattr(metrics_collector, 'evaluate_final_test'), "Missing evaluate_final_test method"
        ...
        assert hasattr(splitter, 'create_incremental_splits'), "Missing create_incremental_splits method"
        ...
        assert hasattr(ra, 'collect_final_test_metrics'), "Missing collect_final_test_metrics method"
        assert hasattr(ra, 'generate_round_comparison_table'), "Missing generate_round_comparison_table method"
        assert hasattr(ra, 'generate_final_comparison_table'), "Missing generate_final_comparison_table method"
        ...
        from src.config.parser import TrainingConfig, DataConfig
