...
class TestAnnotationSerializer:
    ...
    def test_serialize_multiple_annotations(self):
        ...
        annotations = [
            ...
            Annotation(
                class_id=1,
                bbox=BoundingBox(center_x=0.2, center_y=0.3, width=0.1, height=0.2)
            ),
            Annotation(
                class_id=2,
                bbox=BoundingBox(center_x=0.8, center_y=0.7, width=0.15, height=0.25)
            )
        ]
    ...
    def test_serialize_precision(self):
        ...
        annotation = Annotation(
            class_id=0,
            bbox=BoundingBox(center_x=0.123456789, center_y=0.987654321, 
                           width=0.111111111, height=0.999999999)
        )
